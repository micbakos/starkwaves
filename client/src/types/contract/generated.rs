#[derive()]
pub struct StarkwavesGenerated<A: starknet_rust::accounts::ConnectedAccount + Sync> {
...
#[derive()]
pub struct StarkwavesGeneratedReader<P: starknet_rust::providers::Provider + Sync> {
    pub address: starknet_rust::core::types::Felt,
    pub provider: P,
    pub block_id: starknet_rust::core::types::BlockId,
}
...
impl cainome::cairo_serde::CairoSerde for Ship {
    type RustType = Self;
    const SERIALIZED_SIZE: std::option::Option<usize> = None;
    #[inline]
    fn cairo_serialized_size(__rust: &Self::RustType) -> usize {
        let mut __size = 0;
        __size += ShipKind::cairo_serialized_size(&__rust.kind);
        __size += u8::cairo_serialized_size(&__rust.x);
        __size += u8::cairo_serialized_size(&__rust.y);
        __size += Orientation::cairo_serialized_size(&__rust.orientation);
        __size
    }
    fn cairo_serialize(__rust: &Self::RustType) -> Vec<starknet_rust::core::types::Felt> {
        let mut __out: Vec<starknet_rust::core::types::Felt> = vec![];
        __out.extend(ShipKind::cairo_serialize(&__rust.kind));
        __out.extend(u8::cairo_serialize(&__rust.x));
        __out.extend(u8::cairo_serialize(&__rust.y));
        __out.extend(Orientation::cairo_serialize(&__rust.orientation));
        __out
    }
    fn cairo_deserialize(
        __felts: &[starknet_rust::core::types::Felt],
        ...
        let mut __offset = __offset;
        let kind = ShipKind::cairo_deserialize(__felts, __offset)?;
        __offset += ShipKind::cairo_serialized_size(&kind);
        let x = u8::cairo_deserialize(__felts, __offset)?;
        __offset += u8::cairo_serialized_size(&x);
        let y = u8::cairo_deserialize(__felts, __offset)?;
        __offset += u8::cairo_serialized_size(&y);
        let orientation = Orientation::cairo_deserialize(__felts, __offset)?;
        __offset += Orientation::cairo_serialized_size(&orientation);
...
impl cainome::cairo_serde::CairoSerde for TimeoutConfig {
    type RustType = Self;
    const SERIALIZED_SIZE: std::option::Option<usize> = None;
    #[inline]
    fn cairo_serialized_size(__rust: &Self::RustType) -> usize {
        let mut __size = 0;
        __size += u64::cairo_serialized_size(&__rust.committing);
        __size += u64::cairo_serialized_size(&__rust.playing);
        __size += u64::cairo_serialized_size(&__rust.revealing);
        __size
    }
    fn cairo_serialize(__rust: &Self::RustType) -> Vec<starknet_rust::core::types::Felt> {
        let mut __out: Vec<starknet_rust::core::types::Felt> = vec![];
        __out.extend(u64::cairo_serialize(&__rust.committing));
        __out.extend(u64::cairo_serialize(&__rust.playing));
        __out.extend(u64::cairo_serialize(&__rust.revealing));
        __out
    }
    fn cairo_deserialize(
        __felts: &[starknet_rust::core::types::Felt],
        ...
        let mut __offset = __offset;
        let committing = u64::cairo_deserialize(__felts, __offset)?;
        __offset += u64::cairo_serialized_size(&committing);
        let playing = u64::cairo_deserialize(__felts, __offset)?;
        __offset += u64::cairo_serialized_size(&playing);
        let revealing = u64::cairo_deserialize(__felts, __offset)?;
        __offset += u64::cairo_serialized_size(&revealing);
        Ok(TimeoutConfig {
            committing,
            playing,
            revealing,
...
impl cainome::cairo_serde::CairoSerde for Orientation {
    type RustType = Self;
    const SERIALIZED_SIZE: std::option::Option<usize> = std::option::Option::None;
    #[inline]
    fn cairo_serialized_size(__rust: &Self::RustType) -> usize {
    ...
    fn cairo_serialize(__rust: &Self::RustType) -> Vec<starknet_rust::core::types::Felt> {
        match __rust {
            Orientation::Horizontal => usize::cairo_serialize(&0usize),
            Orientation::Vertical => usize::cairo_serialize(&1usize),
            _ => vec![],
        }
    }
    fn cairo_deserialize(
        ...
        let __index = u128::from_be_bytes(__f.to_bytes_be()[16..].try_into().unwrap());
        match __index as usize {
            0usize => Ok(Orientation::Horizontal),
            1usize => Ok(Orientation::Vertical),
            _ => {
                return Err(
                    cainome::cairo_serde::Error::Deserialize(
                        format!("Index not handle for enum {}", "Orientation"),
                    ),
                );
            }
        }
...
impl<A: starknet_rust::accounts::ConnectedAccount + Sync> StarkwavesGenerated<A> {
    ...
    #[allow(clippy::ptr_arg)]
    #[allow(clippy::too_many_arguments)]
    pub fn get_timeout_config(
        &self,
    ) -> cainome::cairo_serde::call::FCall<A::Provider, TimeoutConfig> {
        use cainome::cairo_serde::CairoSerde;
        let mut __calldata = vec![];
        let __call = starknet_rust::core::types::FunctionCall {
            contract_address: self.address,
            entry_point_selector: starknet_rust::macros::selector!("get_timeout_config"),
            calldata: __calldata,
        };
        cainome::cairo_serde::call::FCall::new(__call, self.provider())
    }
    ...
    pub fn reveal_getcall(
        ...
        let mut __calldata = vec![];
        __calldata.extend(starknet_rust::core::types::Felt::cairo_serialize(game_id));
        __calldata.extend(Vec::<Ship>::cairo_serialize(ships));
...
impl<P: starknet_rust::providers::Provider + Sync> StarkwavesGeneratedReader<P> {
    ...
    pub fn get_timeout_config(
        &self,
    ) -> cainome::cairo_serde::call::FCall<P, TimeoutConfig> {
        use cainome::cairo_serde::CairoSerde;
        let mut __calldata = vec![];
        let __call = starknet_rust::core::types::FunctionCall {
            contract_address: self.address,
